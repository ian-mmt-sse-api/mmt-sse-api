...
namespace Mmt_sse_test_api.DBContexts
{
    public partial class TestApiDb : DbContext
    {
        public TestApiDb()
        {
        }

        public TestApiDb(DbContextOptions<TestApiDb> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("name=ConnectionStrings:TestApiDb");
            }
        }
